...
execute if score $hit_cutting_board_check spiced.dummy matches 1 on vehicle run scoreboard players add @s spiced.hit_count 1
...
execute if score $hit_cutting_board_check spiced.dummy matches 1 on vehicle at @s run particle minecraft:item{item:{id:"minecraft:spruce_planks"}} ~ ~-0.25 ~ 0.3 0.1 0.3 0.1 5