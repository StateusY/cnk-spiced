...
execute align xyz run summon item_display 274 109 184 {brightness: {block: 15, sky: 15}, item_display:"ground",Tags:["summit.booth_entity.spiced","spiced.glimpse"],interpolation_duration:10,start_interpolation:0, transformation:{left_rotation: [0.0f, 1f, 0.0f, 1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.0f,0.0f,0.0f]},item:{id:"minecraft:barrier",components:{"minecraft:item_model":"spiced:lettuce_special"}},UUID:[I;-463427330,7358774,-1739627654,-1547238805]}
