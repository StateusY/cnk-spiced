...
execute if score $random_sfx spiced.dummy matches 1 run playsound minecraft:entity.wither_skeleton.hurt ambient @a[tag=summit.in_booth.spiced] ~ ~ ~ 0.15 2
...
execute if score $random_sfx spiced.dummy matches 1 run playsound minecraft:block.note_block.bit ambient @a[tag=summit.in_booth.spiced] ~ ~ ~ 0.5 1
...
execute if score $random_sfx spiced.dummy matches 1 run playsound minecraft:item.lodestone_compass.lock ambient @a[tag=summit.in_booth.spiced] ~ ~ ~ 1 0.75
