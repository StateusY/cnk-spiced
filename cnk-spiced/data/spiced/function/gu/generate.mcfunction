...
execute unless score @s gu.uuid.0 matches -2147483648.. run function spiced:gu/zzz/store_uuid
...
function spiced:gu/zzz/get_hexes with storage gu:temp
function spiced:gu/zzz/concat_uuid with storage gu:temp