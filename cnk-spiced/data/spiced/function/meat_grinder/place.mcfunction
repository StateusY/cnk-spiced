...
function spiced:meat_grinder/macro with storage spiced:temp
scoreboard players set @n[type=minecraft:item_display,tag=spiced.meat_grinder] spiced.hit_count 0
scoreboard players set @n[type=minecraft:item_display,tag=spiced.meat_grinder] spiced.hit_timer 0
scoreboard players set @n[type=minecraft:item_display,tag=spiced.meat_grinder] spiced.item_count 0
