...
# sets the page name
data modify storage spiced:temp register.page_name set value "item.spiced.ethanol"

# sets the ingredients
data modify storage spiced:temp register.ingredients set value [ \
    {key:"item.minecraft.water", font:"spiced.book:icons"}, \
    {key:"item.spiced.corn", font:"spiced.book:icons"}, \
    {key:"item.spiced.cooking_oil", font:"spiced.book:icons"}, \
]
