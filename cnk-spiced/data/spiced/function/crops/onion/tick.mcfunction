execute unless block ~ ~ ~ minecraft:pumpkin_stem run return run function spiced:crops/onion/break
...
execute if score @s cnk.age matches 1 run data modify entity @s item.components."minecraft:item_model" set value "spiced:onion_crop_1"
...
execute if score @s cnk.age matches 2 run data modify entity @s item.components."minecraft:item_model" set value "spiced:onion_crop_2"
...
execute if score @s cnk.age matches 3 run data modify entity @s item.components."minecraft:item_model" set value "spiced:onion_crop_3"
