execute unless block ~ ~ ~ minecraft:pumpkin_stem run return run function spiced:crops/bell_pepper/break
execute unless block ~ ~1 ~ minecraft:air run return run function spiced:crops/bell_pepper/break
...
execute if score @s cnk.age matches 1 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_1"
...
execute if score @s cnk.age matches 2 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_2"
...
execute if score @s cnk.age matches 3 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_3"
...
execute if score @s cnk.age matches 4 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_4"
...
execute if score @s cnk.age matches 5 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_5"
...
execute if score @s cnk.age matches 6 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_6"
...
execute if score @s cnk.age matches 7 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_6"
...
execute if score @s cnk.age matches 8 run data modify entity @s item.components."minecraft:item_model" set value "spiced:bell_pepper_crop_7"
