...
execute if entity @s[tag=spiced.onion_crop] run return run function spiced:crops/onion/tick
execute if entity @s[tag=spiced.bell_pepper_crop] run return run function spiced:crops/bell_pepper/tick