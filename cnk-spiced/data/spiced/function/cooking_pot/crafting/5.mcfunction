execute \
        ...
        if data storage spiced:temp cooking_pot.Items[{components:{"minecraft:custom_data":{spiced:{ingredient:{type:"sliced_celery"}}}}}] \
        if data storage spiced:temp cooking_pot.Items[{components:{"minecraft:custom_data":{spiced:{ingredient:{type:"sliced_onion"}}}}}] \
        ...
        run return run function spiced:recipes/cooking_pot/huntsman_pie_incomplete_1
