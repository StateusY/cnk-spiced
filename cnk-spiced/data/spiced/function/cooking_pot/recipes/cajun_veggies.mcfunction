...
data modify storage spiced:temp cooking_pot.slot set from storage spiced:temp cooking_pot.Items[{components:{"minecraft:custom_data":{spiced:{ingredient:{type:"cajun_seasoning"}}}}}].Slot
function spiced:recipes/remove with storage spiced:temp cooking_pot
