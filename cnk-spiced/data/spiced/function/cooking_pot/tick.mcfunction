...
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:100}} run playsound spiced:block.cooking_pot.idling block @a[distance=..6] ~ ~ ~ 0.4 1
