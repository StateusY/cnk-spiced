...
execute if entity @s[advancements={spiced:npcs/blue=true,spiced:npcs/c4t=true,spiced:npcs/emma_vault=true,spiced:npcs/mantis=true,spiced:npcs/pan=true,spiced:npcs/stateus=true}] run advancement grant @s only summit.sticker_book:spiced/c4t_talking
