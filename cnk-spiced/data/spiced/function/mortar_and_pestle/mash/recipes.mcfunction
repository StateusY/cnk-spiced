...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if function spiced:mortar_and_pestle/mash/generic/ice if score $ice_count spiced.dummy matches 1 \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"ice_cubes"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if data storage spiced:temp mortar_and_pestle.Items[{id:"minecraft:tuff"}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if function spiced:mortar_and_pestle/mash/generic/pepper if score $pepper_count spiced.dummy matches 1 \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"minced_garlic"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"mustard_seeds"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if data storage spiced:temp mortar_and_pestle.Items[{id:"minecraft:sugar"}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 1 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"tomato"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
        run return run data modify entity @s item.components."minecraft:custom_data".spiced.mash_callback set value "spiced:recipes/mortar_and_pestle/tomato_paste"

execute if score $mortar_and_pestle_item_count spiced.dummy matches 3 \
        if data storage spiced:temp mortar_and_pestle.Items[{id:"minecraft:potato"}] \
        if function spiced:mortar_and_pestle/mash/generic/milk if score $milk_count spiced.dummy matches 1 \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 4 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"italian_seasoning"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"black_pepper"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"salt"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"cajun_seasoning"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 4 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"paprika"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"oregano"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"garlic_powder"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"thyme"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 4 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"ground_cinnamon"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"onion_powder"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"garlic_powder"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"mustard_powder"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
...
execute if score $mortar_and_pestle_item_count spiced.dummy matches 5 \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"oregano"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"marjoram"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"rosemary"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"thyme"}}}}}] \
        if data storage spiced:temp mortar_and_pestle.Items[{components:{"minecraft:custom_data":{"spiced":{"ingredient":{"type":"basil"}}}}}] \
        if function spiced:mortar_and_pestle/mash/lock \
