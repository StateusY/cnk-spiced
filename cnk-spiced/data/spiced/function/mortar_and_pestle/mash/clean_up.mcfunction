...
execute on passengers if entity @s[type=minecraft:item_display,tag=spiced.mortar_and_pestle_item] run data modify entity @n[tag=spiced.finished_mortar_and_pestle] item.components."minecraft:custom_data".cnk.last_recipe append from entity @s item
