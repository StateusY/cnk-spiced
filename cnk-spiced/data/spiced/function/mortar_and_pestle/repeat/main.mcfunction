...
execute store result score $pestle_item_count spiced.dummy run data get storage spiced:temp mortar_and_pestle.last_recipe
...
execute unless score $pestle_item_count spiced.dummy matches 1.. run return fail
...
execute unless score $pestle_item_count spiced.dummy matches 2.. run return run function spiced:mortar_and_pestle/mash/main
data modify storage spiced:temp mortar_and_pestle.input set from storage spiced:temp mortar_and_pestle.last_recipe[1]
function spiced:mortar_and_pestle/repeat/insert

execute unless score $pestle_item_count spiced.dummy matches 3.. run return run function spiced:mortar_and_pestle/mash/main
data modify storage spiced:temp mortar_and_pestle.input set from storage spiced:temp mortar_and_pestle.last_recipe[2]
function spiced:mortar_and_pestle/repeat/insert

execute unless score $pestle_item_count spiced.dummy matches 4.. run return run function spiced:mortar_and_pestle/mash/main
data modify storage spiced:temp mortar_and_pestle.input set from storage spiced:temp mortar_and_pestle.last_recipe[3]
function spiced:mortar_and_pestle/repeat/insert

execute unless score $pestle_item_count spiced.dummy matches 5.. run return run function spiced:mortar_and_pestle/mash/main
