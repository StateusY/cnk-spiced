...
execute unless score $pestle_item_count spiced.dummy matches 2.. run return fail
...
execute unless score $pestle_item_count spiced.dummy matches 3.. run return fail
...
execute unless score $pestle_item_count spiced.dummy matches 4.. run return fail
...
execute unless score $pestle_item_count spiced.dummy matches 5.. run return fail
