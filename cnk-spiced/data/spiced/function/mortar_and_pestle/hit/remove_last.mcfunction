execute if score @s cnk.item_count matches 5 on passengers if entity @s[tag=spiced.mortar_and_pestle_5] at @s run function spiced:mortar_and_pestle/item/remove
