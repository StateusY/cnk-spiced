...
execute if items entity @a[tag=spiced.interact_mortar_and_pestle,distance=..20,limit=1] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{spiced:{ingredient:{}}}] run return run function spiced:mortar_and_pestle/item/main