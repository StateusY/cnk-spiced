...
execute if score $global cnk.item_count matches 5 run data merge entity @s {transformation:{left_rotation:[0f,0.5f,0f,1f],right_rotation:[1.15f,-0.2f,-0.1f,1f],scale:[0.4f,0.4f,0.4f],translation:[0.1f,-0.4f,-0.1f]},Tags:["spiced.mortar_and_pestle_item","spiced.mortar_and_pestle_5"],interpolation_duration:3,teleport_duration:2}
