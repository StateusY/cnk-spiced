...
# Play sound function
execute at e0fcef5a-63bd-45ce-bba5-4283f1fc432b run function spiced:pan_womsacz_npc/sounds
...
function spiced:pan_womsacz_npc/zzz/2 with storage chatter:data e0fcef5a-63bd-45ce-bba5-4283f1fc432b