...
execute if entity @s[predicate=spiced:inventory_full] run return run loot spawn ~ ~ ~ loot spiced:food/apple_cider_vinegar
loot give @s loot spiced:food/apple_cider_vinegar
