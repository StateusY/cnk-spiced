...
data modify storage spiced:temp cooking_pot.slot set from storage spiced:temp cooking_pot.Items[{id:'minecraft:beetroot'}].Slot
function spiced:recipes/remove with storage spiced:temp cooking_pot
...
function spiced:recipes/remove with storage spiced:temp cooking_pot
loot spawn ~ ~0.25 ~ loot spiced:food/ratatouille
