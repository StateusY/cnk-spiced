...
playsound minecraft:item.goat_horn.sound.0 block @s ~ ~ ~ 1 2
playsound minecraft:item.goat_horn.sound.1 block @s ~ ~ ~ 1 1.5

loot give @s loot spiced:other/demo_cookbook
loot give @s loot spiced:other/plastic_knife
