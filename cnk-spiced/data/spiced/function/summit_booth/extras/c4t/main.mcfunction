...
execute if items entity @s[advancements={spiced:c4t_translation_flair=false}] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{"spiced":{"translation_key":true,"type":flair}}] run return run function spiced:summit_booth/extras/c4t/translation/switch
execute if items entity @s[advancements={spiced:c4t_translation_spite=false}] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{"spiced":{"translation_key":true,"type":spite}}] run return run function spiced:summit_booth/extras/c4t/translation/switch
execute if items entity @s[advancements={spiced:c4t_translation_study=false}] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{"spiced":{"translation_key":true,"type":study}}] run return run function spiced:summit_booth/extras/c4t/translation/switch

# if key is enabled, refuse it
execute if items entity @s[advancements={spiced:c4t_translation_flair=true}] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{"spiced":{"translation_key":true,"type":flair}}] run return run function spiced:summit_booth/extras/c4t/translation/refuse
execute if items entity @s[advancements={spiced:c4t_translation_spite=true}] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{"spiced":{"translation_key":true,"type":spite}}] run return run function spiced:summit_booth/extras/c4t/translation/refuse
execute if items entity @s[advancements={spiced:c4t_translation_study=true}] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{"spiced":{"translation_key":true,"type":study}}] run return run function spiced:summit_booth/extras/c4t/translation/refuse
