execute positioned 199 53 176 as @a[distance=..1,gamemode=!creative] at @s run function spiced:summit_booth/bounds/cellar/exit
execute positioned 223 57 180 as @a[distance=..3,gamemode=!creative] run function spiced:summit_booth/bounds/cellar/enter
...
execute positioned 223 66 192 as @a[distance=..3,gamemode=!creative, tag=!spiced.entered_booth] run function spiced:summit_booth/bounds/cabin/enter
