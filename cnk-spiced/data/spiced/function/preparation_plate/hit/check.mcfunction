execute if score $hit_preparation_plate_check cnk.dummy matches 1 run return fail

execute on attacker if entity @s[tag=spiced.hit_preparation_plate] run scoreboard players set $hit_preparation_plate_check cnk.dummy 1
execute if score $hit_preparation_plate_check cnk.dummy matches 1 run data remove entity @s attack
