...
function spiced:preparation_plate/macro with storage spiced:temp
scoreboard players set @n[type=minecraft:item_display,tag=spiced.preparation_plate] spiced.hit_count 0
scoreboard players set @n[type=minecraft:item_display,tag=spiced.preparation_plate] spiced.hit_timer 0
scoreboard players set @n[type=minecraft:item_display,tag=spiced.preparation_plate] spiced.item_count 0
