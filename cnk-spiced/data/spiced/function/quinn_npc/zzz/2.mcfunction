...
# Play sound function
execute at 1c312a49-0377-41eb-967e-b29a8311f5c0 run function spiced:quinn_npc/sounds
...
function spiced:quinn_npc/zzz/3 with storage chatter:data 1c312a49-0377-41eb-967e-b29a8311f5c0