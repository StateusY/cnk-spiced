    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.1_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.beef_cutlets,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.beef,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.beef}}}, \
                {"translate":"book.cnk.cutting_board"}, \
                {"translate":"book.item.cnk.beef_cutlets","font":"cnk.book:icons"}, \
