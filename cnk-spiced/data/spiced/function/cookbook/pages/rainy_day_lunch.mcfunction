$dialog show @s { \
  ...
  "body": [ \
    { \
      ...
      "width": 211, \
      "contents": [{ \
            "translate":"book.cnk.2_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.rainy_day_lunch,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.grilled_cheese,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":[{"translate":item.cnk.grilled_cheese},{'translate':book.cnk.hyperlink,'font':'cnk.book:base'}]},'click_event':{'action':'run_command','command':'trigger cnk.cookbook_references set 16'}}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.tomato_soup,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":[{"translate":item.cnk.tomato_soup},{'translate':book.cnk.hyperlink,'font':'cnk.book:base'}]},'click_event':{'action':'run_command','command':'trigger cnk.cookbook_references set 13'}}, \
                {"translate":"book.cnk.cooking_pot"}, \
                {"translate":"book.item.cnk.rainy_day_lunch","font":"cnk.book:icons"}, \
