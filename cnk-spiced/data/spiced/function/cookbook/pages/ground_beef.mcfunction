...
data modify storage cnk:temp register.tool set value "spiced.meat_grinder"
data modify storage cnk:temp register.page_name set value "item.spiced.ground_beef"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.minecraft.beef", font:"cnk.book:icons"}, \
]
