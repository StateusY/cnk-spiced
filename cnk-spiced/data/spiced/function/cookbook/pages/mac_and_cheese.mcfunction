    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.2_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.mac_and_cheese,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.noodles,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":[{"translate":item.cnk.noodles},{'translate':book.cnk.hyperlink,'font':'cnk.book:base'}]},'click_event':{'action':'run_command','command':'trigger cnk.cookbook_references set 7'}}, \
                ...
                {"translate":"book.item.cnk.mac_and_cheese","font":"cnk.book:icons"}, \
                ...
                {"translate":book.tab.cnk.light.active,"hover_event":{"action":"show_text","value":{"translate":book.cnk.section.light}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9924"}}, \
