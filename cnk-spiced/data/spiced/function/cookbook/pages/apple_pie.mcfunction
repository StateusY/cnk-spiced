    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.3_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.apple_pie,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.apple,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.apple}}}, \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.sugar,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.sugar}}}, \
                {"translate":"book.cnk.cooking_pot"}, \
                {"translate":"book.item.cnk.apple_pie","font":"cnk.book:icons"}, \
                ...
                {"translate":book.tab.cnk.dessert.active,"hover_event":{"action":"show_text","value":{"translate":book.cnk.section.dessert}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9927"}}, \
