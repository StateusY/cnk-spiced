    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.3_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.lasagna,"color":"#7b613a","font":"minecraft:default"}, \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.dough,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":[{"translate":item.cnk.dough},{'translate':book.cnk.hyperlink,'font':'cnk.book:base'}]},'click_event':{'action':'run_command','command':'trigger cnk.cookbook_references set 6'}}, \
                {"translate":"book.cnk.cooking_pot"}, \
                {"translate":"book.item.cnk.lasagna","font":"cnk.book:icons"}, \
