    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.front_page","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":book.tab.cnk.front.active,"hover_event":{"action":"show_text","value":{"translate":book.cnk.section.front}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9921"}}, \
                ...
                {"translate":book.cnk.cookbook_front_navigation,"with":[{"translate":book.cnk.empty_incomplete_recipe},{"translate":book.cnk.next_page,"hover_event":{"action":"show_text","value":{"translate":book.cnk.next_page.hover}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9902"}}]} \
            ] \
        }] \
    }, \
    { \
