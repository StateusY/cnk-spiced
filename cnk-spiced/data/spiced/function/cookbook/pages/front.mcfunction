    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.spiced.front_page","font":"spiced:icons","shadow_color":0,"color":"white","with":[ \
                {"translate":book.tab.spiced.front.active,"hover_event":{"action":"show_text","value":{"translate":spiced.section.front}},"click_event":{"action":"run_command","command":"trigger spiced.cookbook_buttons set 9921"}}, \
