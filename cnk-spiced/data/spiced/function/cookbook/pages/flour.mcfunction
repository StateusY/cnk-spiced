    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.spiced.1_recipe","font":"spiced:icons","shadow_color":0,"color":"white","with":[ \
                {"translate":item.spiced.flour,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.spiced.ingredient_template,with:[{"translate":book.item.spiced.wheat,"font":"spiced:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.spiced.wheat}}}, \
                {"translate":"book.spiced.mortar_and_pestle"}, \
                {"translate":"book.item.spiced.flour","font":"spiced:icons"}, \
