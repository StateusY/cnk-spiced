    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.2_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.dough,"color":"#7b613a","font":"minecraft:default"}, \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.water_bottle,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.cnk.water_bottle}}}, \
                {"translate":"book.cnk.mixing_bowl"}, \
                {"translate":"book.item.cnk.dough","font":"cnk.book:icons"}, \
