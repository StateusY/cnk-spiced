    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.3_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.fortune_cookie,"color":"#7b613a","font":"minecraft:default"}, \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.paper,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.paper}}}, \
                {"translate":"book.cnk.cooking_pot"}, \
                {"translate":"book.item.cnk.fortune_cookie","font":"cnk.book:icons"}, \
