    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.spiced.1_recipe","font":"spiced:icons","shadow_color":0,"color":"white","with":[ \
                {"translate":item.spiced.ground_cinnamon,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.spiced.ingredient_template,with:[{"translate":book.item.spiced.cinnamon,"font":"spiced:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.spiced.cinnamon}}}, \
                {"translate":"book.spiced.mortar_and_pestle"}, \
                {"translate":"book.item.spiced.ground_cinnamon","font":"spiced:icons"}, \
