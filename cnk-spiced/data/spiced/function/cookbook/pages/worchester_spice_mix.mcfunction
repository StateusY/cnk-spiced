...
data modify storage cnk:temp register.page_name set value "item.spiced.worchester_spice_mix"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.spiced.mustard_powder", font:"spiced:icons"}, \
    {key:"item.spiced.onion_powder", font:"spiced:icons"}, \
    {key:"item.spiced.garlic_powder", font:"spiced:icons"}, \
