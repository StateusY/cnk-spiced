...
data modify storage cnk:temp register.page_name set value "item.spiced.music_disc_green_regime"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.any_disc", font:"cnk.book:icons"}, \
    {key:"item.spiced.reasonable_amount_of_lettuce", font:"spiced:icons"}, \
]
