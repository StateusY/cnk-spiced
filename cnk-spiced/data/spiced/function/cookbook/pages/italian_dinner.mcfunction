$dialog show @s { \
  ...
  "body": [ \
    { \
      ...
      "width": 211, \
      "contents": [{ \
            "translate":"book.cnk.4_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.italian_dinner,"color":"#7b613a","font":"minecraft:default"}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.spaghetti,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":[{"translate":item.cnk.spaghetti},{'translate':book.cnk.hyperlink,'font':'cnk.book:base'}]},'click_event':{'action':'run_command','command':'trigger cnk.cookbook_references set 19'}}, \
                ...
                {"translate":"book.item.cnk.italian_dinner","font":"cnk.book:icons"}, \
                ...
                {"translate":book.tab.cnk.feast.active,"hover_event":{"action":"show_text","value":{"translate":book.cnk.section.feast}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9926"}}, \
