...
data modify storage cnk:temp register.page_name set value "item.spiced.cajun_veggies"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.spiced.minced_garlic", font:"spiced:icons"}, \
    {key:"item.spiced.cajun_seasoning", font:"spiced:icons"}, \
    {key:"item.spiced.diced_celery", font:"spiced:icons"}, \
    {key:"item.spiced.diced_bell_pepper", font:"spiced:icons"}, \
    {key:"item.spiced.diced_onion", font:"spiced:icons"}, \
]
