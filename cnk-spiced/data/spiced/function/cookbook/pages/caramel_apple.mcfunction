    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.2_recipe","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":item.cnk.caramel_apple,"color":"#7b613a","font":"minecraft:default"}, \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.caramel,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":[{"translate":item.cnk.caramel},{'translate':book.cnk.hyperlink,'font':'cnk.book:base'}]},'click_event':{'action':'run_command','command':'trigger cnk.cookbook_references set 25'}}, \
                {"translate":"book.cnk.cooking_pot"}, \
                {"translate":"book.item.cnk.caramel_apple","font":"cnk.book:icons"}, \
