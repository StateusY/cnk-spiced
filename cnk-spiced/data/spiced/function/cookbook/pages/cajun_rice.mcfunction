...
data modify storage cnk:temp register.page_name set value "item.spiced.cajun_rice"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.spiced.worchester_sauce", font:"spiced:icons"}, \
    {key:"item.spiced.sliced_tomato", font:"spiced:icons"}, \
