execute if data storage spiced:temp register.ingredients[0] run function spiced:cookbook/pages/check_font with storage spiced:temp register.ingredients[0]
...
execute if data storage spiced:temp register.ingredients[1] run function spiced:cookbook/pages/check_font with storage spiced:temp register.ingredients[1]
...
execute if data storage spiced:temp register.ingredients[2] run function spiced:cookbook/pages/check_font with storage spiced:temp register.ingredients[2]
...
execute if data storage spiced:temp register.ingredients[3] run function spiced:cookbook/pages/check_font with storage spiced:temp register.ingredients[3]
...
execute if data storage spiced:temp register.ingredients[4] run function spiced:cookbook/pages/check_font with storage spiced:temp register.ingredients[4]
...
function spiced:cookbook/pages/check_font with storage spiced:temp register.font_check
