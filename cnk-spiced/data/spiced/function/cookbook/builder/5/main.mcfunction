...
data modify storage spiced:temp cookbook.ingredient.id set from storage spiced:temp cookbook.current_page.ingredients[3].key
data modify storage spiced:temp cookbook.ingredient.font set from storage spiced:temp cookbook.data.font_4
data modify storage spiced:temp cookbook.ingredient.flag set from storage spiced:temp cookbook.data.slot_4
data modify storage spiced:temp cookbook.ingredient.position set value 4
function spiced:cookbook/builder/resolve_ingredient with storage spiced:temp cookbook.ingredient
data modify storage spiced:temp cookbook.ingredient.4 set from storage spiced:temp cookbook.ingredient.output

data modify storage spiced:temp cookbook.ingredient.id set from storage spiced:temp cookbook.current_page.ingredients[4].key
data modify storage spiced:temp cookbook.ingredient.font set from storage spiced:temp cookbook.data.font_5
data modify storage spiced:temp cookbook.ingredient.flag set from storage spiced:temp cookbook.data.slot_5
data modify storage spiced:temp cookbook.ingredient.position set value 5
function spiced:cookbook/builder/resolve_ingredient with storage spiced:temp cookbook.ingredient
data modify storage spiced:temp cookbook.ingredient.5 set from storage spiced:temp cookbook.ingredient.output

function spiced:cookbook/builder/5/merge with storage spiced:temp cookbook.ingredient