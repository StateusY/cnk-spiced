...
# see the spiced:cookbook/pumpkin_pie/item advancement for the advancement that calls this function
...
execute unless score $set_success cnk.dummy matches 1 run return run advancement revoke @s only spiced:cookbook/pumpkin_pie/item
...
advancement grant @s[tag=!cnk.cookbook_unlock,tag=!cnk.no_toasts] only spiced:cookbook/pumpkin_pie/toast