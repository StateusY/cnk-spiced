...
scoreboard players operation $next_page spiced.dummy = $feasts_page spiced.dummy
function spiced:cookbook/buttons/check_incomplete_recipe/main

scoreboard players operation @s spiced.cookbook_current_page = $feasts_page spiced.dummy
