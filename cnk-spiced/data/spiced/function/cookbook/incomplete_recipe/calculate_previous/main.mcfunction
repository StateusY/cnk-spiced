execute if score @s[tag=!spiced.on_incomplete_page] spiced.next_incomplete_recipe matches -1 run function spiced:cookbook/incomplete_recipe/calculate_next/main
