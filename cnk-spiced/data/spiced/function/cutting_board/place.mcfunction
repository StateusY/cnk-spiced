...
execute align xyz run summon item_display ~0.5 ~ ~0.5 {Tags:["spiced.cutting_board","summit.static","summit.booth_entity.spiced"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[1.01f,1.01f,1.01f],translation:[0.0f,0.5f,0.0f]},item:{id:"minecraft:barrier",components:{"minecraft:item_model":"spiced:cutting_board"}},Rotation:[0.0,0.0],Passengers:\
    [\
