...
execute if score #length spiced.dummy matches 0 run function spiced:vault_emma_npc/zzz/0
...
function spiced:vault_emma_npc/zzz/1 with storage spiced:temp args