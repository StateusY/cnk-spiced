...
# Play sound function
execute at e2e84d58-29e9-48e3-8998-f6edb7f44062 run function spiced:vault_emma_npc/vault/sounds
...
function spiced:vault_emma_npc/vault/zzz/2 with storage chatter:data e2e84d58-29e9-48e3-8998-f6edb7f44062