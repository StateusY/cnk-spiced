...
function spiced:bush_npc/says {message:[{text:'Pink', color: '#2a5f0a'}, ' ponies', ' and', ' purple', ' giraffes', ' roamed', ' the', ' field.']}
schedule function spiced:bush_npc/zzz/107 112t replace