...
function spiced:bush_npc/says {message:[{text:'Bryan', color: '#2a5f0a'}, ' had', ' made', ' peace', ' with', ' himself', ' and', ' felt', ' comfortable', ' with', ' the', ' choices', ' he', ' made.']}
schedule function spiced:bush_npc/zzz/51 179t replace