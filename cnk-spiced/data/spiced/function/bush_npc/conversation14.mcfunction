...
function spiced:bush_npc/says {message:[{text:'The', color: '#2a5f0a'}, ' leather', ' jacket', ' showed', ' the', ' scars', ' of', ' being', ' his', ' favorite', ' for', ' years.']}
schedule function spiced:bush_npc/zzz/125 152t replace