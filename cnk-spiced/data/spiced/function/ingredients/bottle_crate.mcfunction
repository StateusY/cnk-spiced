...
playsound minecraft:block.note_block.chime block @a[tag=summit.in_booth.spiced,distance=..15] ~ ~ ~ 0.2 1.3
playsound minecraft:block.glass.break block @a[tag=summit.in_booth.spiced,distance=..15] ~ ~ ~ 0.2 1.3
