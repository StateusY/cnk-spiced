...
# Play sound function
execute at b57a3c1f-68da-441b-9361-f092d6630b55 run function spiced:c4t_npc/sounds
...
function spiced:c4t_npc/zzz/2 with storage chatter:data b57a3c1f-68da-441b-9361-f092d6630b55