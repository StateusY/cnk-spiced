...
data modify storage spiced:temp register.ingredients set value [{key: "item.spiced.chicken", font: "spiced:icons"}, {key: "item.spiced.diced_bread", font: "spiced:icons"}, {key: "item.spiced.huntsman_pie_incomplete_1", font: "spiced:icons"}, {key: "item.spiced.porkchop", font: "spiced:icons"}]
