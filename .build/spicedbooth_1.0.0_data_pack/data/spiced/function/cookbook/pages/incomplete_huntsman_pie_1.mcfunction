...
data modify storage spiced:temp register.ingredients set value [{key: "item.spiced.sliced_celery", font: "spiced:icons"}, {key: "item.spiced.stock", font: "spiced:icons"}, {key: "item.spiced.cooking_oil", font: "spiced:icons"}, {key: "item.spiced.sliced_onion", font: "spiced:icons"}, {key: "item.spiced.ground_cinnamon", font: "spiced:icons"}]
