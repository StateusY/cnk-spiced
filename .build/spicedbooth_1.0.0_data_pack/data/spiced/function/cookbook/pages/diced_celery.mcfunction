...
data modify storage spiced:temp register.tool set value "spiced.cutting_board"
data modify storage spiced:temp register.page_name set value "item.spiced.diced_celery"
data modify storage spiced:temp register.recipe_icon_font set value "spiced:icons"
data modify storage spiced:temp register.ingredients set value [{key: "item.spiced.sliced_celery", font: "spiced:icons"}]
