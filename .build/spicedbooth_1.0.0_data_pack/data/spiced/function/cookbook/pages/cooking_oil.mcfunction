...
data modify storage spiced:temp register.ingredients set value [{key: "item.spiced.glass_bottle", font: "spiced:icons"}, {key: "item.spiced.sunflower", font: "spiced:icons"}]
