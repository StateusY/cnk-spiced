data merge entity @s {transformation: {left_rotation: [0.0f, 0.5f, 0.0f, 1.0f], right_rotation: [-1.0f, 0.0f, 0.0f, 1.0f], scale: [0.55f, 0.55f, 0.55f], translation: [0.0f, -0.42f, -0.05f]}, Tags: ["spiced.cutting_board_item"]}
