	...
	*/
	...
	resolve(v) {
		...
		if (Reflect__1.isObject(this.context)) {
			let value = Reflect__1.getProperty(this.context, v);
		...
		while (_g_head != null) {
			...
			let ctx = val;
			let value = Reflect__1.getProperty(ctx, v);
	...
	run(e) {
		switch (e._hx_index) {
			...
			case 6:
				let m = e.name;
				let params = e.params;
				let v4 = Reflect__1.field(this.macros, m);
				let pl = new Array();
				let old = this.buf;
