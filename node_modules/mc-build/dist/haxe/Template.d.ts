...
export declare namespace TemplateExpr {
	export type OpVar = {"@kind": "OpVar", _hx_index: 0, v: string, __enum__: "haxe._Template.TemplateExpr"}
	export const OpVar: (v: string) => TemplateExpr
	export type OpStr = {"@kind": "OpStr", _hx_index: 3, str: string, __enum__: "haxe._Template.TemplateExpr"}
	export const OpStr: (str: string) => TemplateExpr
	export type OpMacro = {"@kind": "OpMacro", _hx_index: 6, name: string, params: List<TemplateExpr>, __enum__: "haxe._Template.TemplateExpr"}
	export const OpMacro: (name: string, params: List<TemplateExpr>) => TemplateExpr
	export type OpIf = {"@kind": "OpIf", _hx_index: 2, expr: (() => any), eif: TemplateExpr, eelse: TemplateExpr, __enum__: "haxe._Template.TemplateExpr"}
	export const OpIf: (expr: (() => any), eif: TemplateExpr, eelse: TemplateExpr) => TemplateExpr
	export type OpForeach = {"@kind": "OpForeach", _hx_index: 5, expr: (() => any), loop: TemplateExpr, __enum__: "haxe._Template.TemplateExpr"}
	export const OpForeach: (expr: (() => any), loop: TemplateExpr) => TemplateExpr
	export type OpExpr = {"@kind": "OpExpr", _hx_index: 1, expr: (() => any), __enum__: "haxe._Template.TemplateExpr"}
	export const OpExpr: (expr: (() => any)) => TemplateExpr
	export type OpBlock = {"@kind": "OpBlock", _hx_index: 4, l: List<TemplateExpr>, __enum__: "haxe._Template.TemplateExpr"}
